...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2021 at 10:24 AM
...
INSERT INTO `reservation` (`Rev_id`, `uid`, `Rev_name`, `Rev_email`, `Rev_phone`, `Rev_IdnPan`, `Rev_Add`, `Rev_Sdate`, `Rev_Edate`, `rev_adults`, `rev_child`, `rev_totalguest`, `Rev_roomno`, `Rev_roomtype`, `Room_total`, `status`) VALUES
(73, 13, 'rabina', 'fjuyg@h.com', '9876543210', 'ndndfgsgsrr', 'ghy', '2021-03-03', '2021-03-05', 2, 0, 2, 201, 'Double', 2000, 0),
(74, 13, 'rabina', 'Abhi@a.com', '9567891234', 'shjgdjdhsg6', 'asdf', '2021-03-03', '2021-03-05', 2, 0, 2, 101, 'Single', 1000, 1);
...
--
ALTER TABLE `reservation`
  MODIFY `Rev_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT for table `rooms`
--
ALTER TABLE `rooms`
  MODIFY `Roomid` int(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=350;
